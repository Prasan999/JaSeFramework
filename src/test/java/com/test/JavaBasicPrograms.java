...
public class JavaBasicPrograms {
	...
	@Test
	public void duplicateCharactersCount() {
	...
	@Test
	public void withoutDuplicateWords() {
		...
		for( int i=0;i<strArray.length;i++  ){
			...
			for( int j=i+1;j<strArray.length;j++){
				...
				if(!strArray[i].equals(strArray[j])){
					...
					stringWithoutDuplicates = stringWithoutDuplicates+strArray[i];
				}
	...
	public void ReverseEachWordInString () {
		...
		String str = "Test Bed Matters";
		String[] strArray =str.split(" "); 
		int strlength = strArray.length;
		String finalReverseWords="";

		for(int i=0;i<strlength;i++) { 

			String s =reverseWords(strArray[i]);
			finalReverseWords+=s;
		}
		System.out.println(finalReverseWords);
	}
	...
	@Test
	public void reverseEachWordStringBuffer() {

		String str = "Test Bed Matters";
		String[] words =str.split(" "); 
		StringBuilder finalReverseWords =new StringBuilder();
		...
		for(String word : words) {
			...
			finalReverseWords.append(reverseWords.reverse().append(" "));
 ...
 * 
 * (//div[contains(text(),'Motorola Edge 50 * ')][1]//following::span[3]/span[3])[1]- bad path
 * 
 * //div[contains(text(),'Motorola Edge 50 Fusion (Blue, 256 * GB)')]//following::span[3]
 * 
 * 
 * //div[text()='Motorola Edge 50 Fusion (Blue, 256 GB)']//following::span[3]
 * 
 * //div[contains(text(),'Motorola Edge 50 Fusion (Blue, 256 * GB)')]//following::span[contains(text(),'Reviews')][1]   -- best path
 */
